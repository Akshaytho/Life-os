    ...
    <div className="life-app">
      <main className={styles.canvas}>
        ...
        <section className={styles.hero}>
          <div className={styles.heroTop}><span>CALENDAR / SYNTHETIC VISUAL REVIEW</span><span>MANUAL ENTRY</span></div>
          <div className={styles.heroGrid}><div><span className="section-kicker">TIME-BOUND REALITY</span><h1>Commit time. See what is real.</h1></div><p>Manual entry is explicit and does not require AI.</p></div>
        </section>
